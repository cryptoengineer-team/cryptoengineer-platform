...
def eval_model(model, fec_ini, fec_fin):
    ...
    # Se leen los datos de XDGUSD utilizando la SDK de cryptoengineersdk
    table_name = "silver_t_cryptos"  # Nombre de la tabla
    crypto_file = "XDGUSD"  # Se define el símbolo específico

    # Se obtienen los datos de XDGUSD desde la tabla correspondiente
    ...
    # Se renombraron las columnas del DataFrame con los nuevos nombres establecidos
