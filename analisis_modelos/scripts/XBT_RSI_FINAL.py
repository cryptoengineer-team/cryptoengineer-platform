...
def eval_model(model, fec_ini, fec_fin):
    ...
    # Se leen los datos de XBTUSD utilizando la SDK de cryptoengineersdk
    table_name = "silver_t_cryptos"  # Nombre de la tabla
    crypto_file = "XBTUSD"  # Se define el símbolo específico

    # Se obtienen los datos de XBTUSD desde la tabla correspondiente
